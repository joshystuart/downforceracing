        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              <h1 className="section-title text-center">What theyapos;ve said</h1>
          ...
          <div className="row margin-t-50">
              ...
              <div className="testimonial-box hover-effect margin-t-30">
                ...
                <div className="testimonial-decs">
                  <p className="text-muted text-center mb-0">
                    I feel confident imposing change on myself. Itapos;s a lot more fun progressing than looking back.
                    Thatapos;s why I need to throw curve balls.
                  </p>
                </div>
            ...
            <div className="col-lg-4">
              <div className="testimonial-box hover-effect margin-t-30">
                ...
                <div className="testimonial-decs">
                  <p className="text-muted text-center mb-0">
                    Iapos;ve learned that people will forget what you said, people will forget what you did, but people
