        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              <p className="section-subtitle text-muted text-center font-secondary padding-t-30">
                In an ideal world this website wouldn’t exist, a client would acknowledge the importance of having web
          ...
          <div className="row margin-t-50">
            ...
            <div className="text-center mx-auto">
              <Link to="" className="btn btn-custom waves-light waves-effect margin-t-50">
